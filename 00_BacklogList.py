...
gb.configure_column('Status',width=80,cellEditor='agSelectCellEditor',cellEditorParams={'values':teamList},rowDrag=False) 
gb.configure_column('ReceivedDate',width=90,rowDrag=False) 
gb.configure_column('Analyst',width=90,cellEditor='agSelectCellEditor',cellEditorParams={'values':taskStatus},rowDrag=False)
